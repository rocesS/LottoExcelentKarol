...
class ResultAnnouncerFacadeTest {
    ...
    void should_return_correct_lottery_results_with_winning_message_when_user_won() {
        ...
        given(resultCheckerFacade.checkWinner(any(String.class)))
                .willReturn(lotteryResultDto);

        //when
        LotteryAnnouncementDto result = resultAnnouncerFacade.checkWinner(UUID.randomUUID().toString());
    ...
    void should_return_correct_lottery_results_with_losing_message_when_user_lost() {
        ...
        given(resultCheckerFacade.checkWinner(any(String.class))).willReturn(lotteryResultDto);
